...
1.  **[Quantum Neural Networks](./Tutorials/Quantum%20Neural%20Networks.ipynb)**
    ...
    * **Original Tutorial**: [neural_networks](https://qiskit-community.github.io/qiskit-machine-learning/tutorials/01_neural_networks.html)

2.  **[Neural Network Classifier & Regressor](./Tutorials/Neural%20Network%20Classifier%20&%20Regressor.ipynb)**
    ...
    * **Original Tutorial**: [neural_network_classifier_and_regressor](https://qiskit-community.github.io/qiskit-machine-learning/tutorials/02_neural_network_classifier_and_regressor.html)

3.  **[Training a Quantum Model on a Real Dataset](./Tutorials/Training%20a%20Quantum%20Model%20on%20a%20Real%20Dataset.ipynb)**
    ...
    * **Original Tutorial**: [training_a_quantum_model_on_a_real_dataset](https://qiskit-community.github.io/qiskit-machine-learning/tutorials/02a_training_a_quantum_model_on_a_real_dataset.html)

4.  **[Torch Connector and Hybrid QNNs](./Tutorials/Torch%20Connector%20and%20Hybrid%20QNNs.ipynb)**
    ...
    * **Original Tutorial**: [torch_connector](https://qiskit-community.github.io/qiskit-machine-learning/tutorials/05_torch_connector.html)
